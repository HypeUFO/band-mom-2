...
export function bandReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case ActionTypes.UPDATE_MEMBER_EDIT_REQUESTED:
      return {
        ...state
      };
    case ActionTypes.UPDATE_MEMBER_EDIT_FULFILLED:
      return {
        ...state,
        memberEdit: !state.memberEdit
      };
    case ActionTypes.UPDATE_MEMBER_EDIT_REJECTED:
      return {
        ...state,
        error: action.error
      };

    case ActionTypes.UPDATE_MEMBER_REQUESTED:
      return {
        ...state
      };
