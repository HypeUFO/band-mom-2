...
const notificationList = {
  1: {
    message: "Someone has invited you to join their group",
    action: "acceptGroupInvite",
    actionType: "Confirm",
    actionId: "-L2J1Ug6x2IeDZdNLZLO"
  },
            ...
            <CardSection>
              <div className="form__row">
                <Input
                  ...
                  value="Dismiss"
                  onCancel={() =>
                    this.props.declineGroupInvite(
                      notifications[key].actionId,
                      this.props.user.id,
                      key
                    )
                  }
                ...
                {notifications[key].action ? (
                  <Input
                    ...
                    onClick={() => {
                      ...
                      this.props[notifications[key].action](
                        notifications[key].band,
                        notifications[key].recipient,
                        key
                      );
                    }}
                  />
